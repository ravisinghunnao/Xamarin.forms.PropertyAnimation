...
namespace Animation
{
    public class ThicknessAnimation : AbstractAnimation
    {
        ...
        public override Xamarin.Forms.Animation CreateFarwardAnimation()
        {
            ...
            else if (_structStartValues.Length == 2)
            {
                return CreateFarwardAnimationForTwoValues();
            }
        ...
        private Xamarin.Forms.Animation CreateFarwardAnimationForFourValues()
        {
            ...
            var Parent = new Xamarin.Forms.Animation((d) => Target.GetType().GetProperty(PropertyName).SetValue(Target, new Thickness(v1, v2, v3, v4)), 0, 1, AnimationEasing);
        ...
        private Xamarin.Forms.Animation CreateFarwardAnimationForTwoValues()
        {
            double v1 = 0, v2 = 0;
        ...
        private Xamarin.Forms.Animation CreateFarwardAnimationForSingleValue()
        {
            ...
            {
                Target.GetType().GetProperty(PropertyName).SetValue(Target, new Thickness(d));
        ...
        public override Xamarin.Forms.Animation CreateReverseAnimation()
        {
            ...
            {
                return CreateReverseAnimationForTwoValues();
            }
            else if (_structStartValues.Length == 4)
            {
